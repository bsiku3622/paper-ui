...
import { badgeRoot, badgeSize, badgeDot } from "./Badge.css";
...
export const Badge = forwardRef<HTMLSpanElement, BadgeProps>(function Badge(
  { color = "primary", variant = "soft", size = "md", dot, children, className, ...rest },
  ref,
) {
  return (
    <span
      ref={ref}
      className={joinClass(badgeRoot, badgeSize[size], resolveColor(color, variant), className)}
      {...rest}
    >
