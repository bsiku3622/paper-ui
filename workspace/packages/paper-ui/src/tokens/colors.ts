...
export const BORDER = {
  ...
  control: "#92929b", // 그 자체가 컨트롤인 선 (흰 면 위 3.09:1) — 입력 · 체크박스 · outline
  controlHover: "#71717a", // 그 hover. 쉬는 상태가 이미 3:1 이라 hover 는 확실히 더 진해야 한다
} as const;
...
const BORDER_DARK = {
  ...
  control: "#5e5e64", //      raised 3.01 · canvas 2.95
  controlHover: "#79797e", // raised 4.48
} as const;
